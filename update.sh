sudo rm -R ~/QbusOpenHab    # Verwijderen van oude files
git clone https://github.com/QbusKoen/QbusOH3 ~/QbusOpenHab    # Downloaden van nieuwe bestanden
sudo rm /usr/share/openhab/addons/org.openhab.binding.qbus-*      # Verwijderen van alle Qbus-JAR files
sudo cp ~/QbusOpenHab/JAR/org.openhab.binding.qbus-3.1.0-SNAPSHOT.jar /usr/share/openhab/addons/    # Kopiëren van huidige JAR naar openHAB
